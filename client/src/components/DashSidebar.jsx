...
import { HiChartPie, HiArrowSmRight, HiUser, HiDocumentText, HiAnnotation, HiOutlineUserGroup } from 'react-icons/hi';
          ...
          {currentUser && currentUser.isAdmin && (
            <>
              <Link to="/dashboard?tab=posts">
                <Sidebar.Item active={tab === 'posts'} icon={HiDocumentText} label={20} as='div'>Posts</Sidebar.Item>
              </Link>
