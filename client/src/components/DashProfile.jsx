...
const DashProfile = () => {
  ...
  const handleImageChnage = async (e) => {
    const file = e.target.files[0];
    if (file) {
      setImageFile(file);
      // todo : this need to understand
      ...
      <Modal show={showModel} onClose={() => setShowModel(false)} popup size='md'>
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <h3 className='mb-5 text-lg text-gray-500 dark:test-gray-400'>Are you sure your want to delete your account ?</h3>
